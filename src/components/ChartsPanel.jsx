...
const CASH_FLOW_SANKEY_DATA = {
  ...
  links: [
    ...
    { source: 4, target: 5, level: 2, value: 229 },
    { source: 4, target: 6, level: 2, value: 59 },
    { source: 4, target: 7, level: 2, value: 56 },
    { source: 4, target: 8, level: 2, value: 55 },
    { source: 9, target: 11, level: 3, value: 18 },
    { source: 5, target: 10, level: 3, value: 58 },
    { source: 10, target: 11, level: 4, value: 51 },
    { source: 10, target: 12, level: 4, value: 7 },
    { source: 11, target: 13, level: 5, value: 18 },
    { source: 11, target: 14, level: 5, value: 51 },
    { source: 14, target: 15, level: 6, value: 51 },
  ],
};
